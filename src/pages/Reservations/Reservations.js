    ...
    <div data-testid="reservations-component" className="reservation">
      ...
      {isPopupVisible && (
        <Popup
          ...
          description="Thank you for choosing Little Lemon! Your reservation has been successfully made. You will receive a confirmation text with the details of your reservation. We are excited to see you soon!"
        />
      )}
    </div>
  );
